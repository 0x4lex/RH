<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_TipoDeduccion where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_TipoDeduccion'];
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_TipoDeduccion"><h4>Recursos humanos / Datos maestros / Tipo deduccion</h4></a></li>
							<?php 
						if($accion=='agregar'){
							echo"<li class='active'>Añadir Tipo deduccion</li>";
						}
						if($accion=='editar'){
							echo"<li class='active'>Editar Tipo deduccion</li>";
						}
						if($accion=='ver'){
							echo"<li class='active'>Ver Tipo deduccion</li>";
						}
						if($accion=='borrar'){
							echo"<li class='active'>Borrar Tipo deduccion</li>";
						}
						?>
						</ol>
					</div>
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Tipo deduccion</label>
										</div>
...
<script src="styles/js/c_TipoDeduccion/c_TipoDeduccion_Agregar.js"></script>
<!-- Clases -->
<script>
	   $(function () {
