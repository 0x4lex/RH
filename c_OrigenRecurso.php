<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_OrigenRecurso where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_OrigenRecurso'];
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_OrigenRecurso"><h4>Recursos humanos / Datos maestros / Origen recurso</h4></a></li>
							<?php 
						if($accion=='agregar'){
							echo"<li class='active'>Añadir origen recurso</li>";
						}
						if($accion=='editar'){
							echo"<li class='active'>Editar origen recurso</li>";
						}
						if($accion=='ver'){
							echo"<li class='active'>Ver Tipo origen recurso</li>";
						}
						if($accion=='borrar'){
							echo"<li class='active'>Borrar origen recurso</li>";
						}
						?>
						</ol>
					</div>
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Origen recurso</label>
										</div>
...
<script src="styles/js/c_OrigenRecurso/c_OrigenRecurso_Agregar.js"></script>
<!-- Clases -->
<script>
