<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_Periodicidad where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_PeriodicidadPago'];
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_Periodicidad"><h4>Recursos Humanos / Datos Maestros / Periodicidad</h4></a></li>
							<?php 
						if($accion=='agregar'){
							echo"<li class='active'>Añadir Tipo periodicidad</li>";
						}
						if($accion=='editar'){
							echo"<li class='active'>Editar Tipo periodicidad</li>";
						}
						if($accion=='ver'){
							echo"<li class='active'>Ver Tipo periodicidad</li>";
						}
						if($accion=='borrar'){
							echo"<li class='active'>Borrar Tipo periodicidad</li>";
						}
						?>
						</ol>
					</div>
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Periodicidad</label>
										</div>
...
<script src="styles/js/c_Periodicidad/c_Periodicidad_Agregar.js"></script>
<!-- Clases -->
<script>
	   $(function () {
