<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_TipoContrato where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_TipoContrato'];
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_TipoContrato"><h4>Recursos humanos / Datos maestros / Tipo contrato</h4></a></li>
							<?php 
						if($accion=='agregar'){
							echo"<li class='active'>Añadir Tipo contrato</li>";
						}
						if($accion=='editar'){
							echo"<li class='active'>Editar Tipo contrato</li>";
						}
						if($accion=='ver'){
							echo"<li class='active'>Ver Tipo contrato</li>";
						}
						if($accion=='borrar'){
							echo"<li class='active'>Borrar contrato</li>";
						}
						?>
						</ol>
					</div>
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Tipo contrato</label>
										</div>
...
<script src="styles/js/c_TipoContrato/c_TipoContrato_agregar.js"></script>
<!-- Clases -->
<script>
