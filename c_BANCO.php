<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_BANCO where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_banco'];
		$razon=$r['Nombre_razonSocial'];
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_BANCO"><h4>Recursos Humanos / Datos Maestros / Banco</h4></a></li>
							<?php 
						if($accion=='agregar'){
							echo"<li class='active'>Añadir Tipo banco</li>";
						}
						if($accion=='editar'){
							echo"<li class='active'>Editar Tipo banco</li>";
						}
						if($accion=='ver'){
							echo"<li class='active'>Ver Tipo banco</li>";
						}
						if($accion=='borrar'){
							echo"<li class='active'>Borrar Tipo banco</li>";
						}
						?>
						</ol>
					</div>
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Banco</label>
										</div>
										...
										<div class="form-group floating-label">
											<input type="text" class="form-control" name="razon" id="razon" value="<?php echo $razon;?>">
											<label for="regular2">Razon social</label>
...
<script src="styles/js/c_BANCO/c_BANCO_Agregar.js"></script>
<!-- Clases -->
<script>
	   $(function () {
