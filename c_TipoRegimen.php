<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_TipoRegimen where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_TipoRegimen'];
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_TipoRegimen"><h4>Recursos Humanos / Datos Maestros / Tipo Regimen</h4></a></li>
							<?php 
						if($accion=='agregar'){
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Tipo de regimen</label>
										</div>
...
<script src="styles/js/c_TipoRegimen/c_TipoRegimen_Agregar.js"></script>
<!-- Clases -->
<script>
