<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_TipoJornada where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_TipoJornada'];
		}
		?>
		<div id="base">
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_TipoJornada"><h4>Recursos humanos / Datos maestros / Tipo jornada</h4></a></li>
							<?php 
						if($accion=='agregar'){
							echo"<li class='active'>Añadir Tipo jornada</li>";
						}
						if($accion=='editar'){
							echo"<li class='active'>Editar Tipo jornada</li>";
						}
						if($accion=='ver'){
							echo"<li class='active'>Ver Tipo jornada</li>";
						}
						if($accion=='borrar'){
							echo"<li class='active'>Borrar Tipo jornada</li>";
						}
						?>
						</ol>
					</div>
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Tipo jornada</label>
										</div>
...
<script src="styles/js/c_TipoJornada/c_TipoJornada_Agregar.js"></script>
<!-- Clases -->
<script>
