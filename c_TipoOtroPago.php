<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_TipoOtroPago where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_TipoOtroPago'];
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_TipoOtroPago"><h4>Recursos humanos / Datos maestros / Tipo otro pago</h4></a></li>
							<?php 
						if($accion=='agregar'){
							echo"<li class='active'>Añadir Tipo otro pago</li>";
						}
						if($accion=='editar'){
							echo"<li class='active'>Editar Tipo otro pago</li>";
						}
						if($accion=='ver'){
							echo"<li class='active'>Ver Tipo otro pago</li>";
						}
						if($accion=='borrar'){
							echo"<li class='active'>Borrar Tipo otro pago</li>";
						}
						?>
						</ol>
					</div>
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Tipo otro pago</label>
										</div>
...
<script src="styles/js/c_TipoOtroPago/c_TipoOtroPago_Agregar.js"></script>
<!-- Clases -->
<script>
	   $(function () {
