<!-- BEGIN BASE-->
		...
		$ide=$_GET['id'];
		$query="SELECT*FROM c_TipoNomina where id='$ide'";
		$res=mysqli_query($conn,$query)or die(mysqli_error($conn));
		$r=mysqli_fetch_array($res);
		$nome=$r['Descripcion'];
		$regimen=$r['c_TipoNomina'];
		}
		?>
		<div id="base">
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="?modulo=c_TipoNomina"><h4>Recursos humanos / Datos maestros / Tipo nomina</h4></a></li>
							<?php 
						if($accion=='agregar'){
							echo"<li class='active'>Añadir Tipo nomina</li>";
						}
						if($accion=='editar'){
							echo"<li class='active'>Editar Tipo nomina</li>";
						}
						if($accion=='ver'){
							echo"<li class='active'>Ver Tipo nomina</li>";
						}
						if($accion=='borrar'){
							echo"<li class='active'>Borrar Tipo nomina</li>";
						}
						?>
						</ol>
					</div>
							...
							<div class="card-head style-primary">
								...
								<div class="card-body">
										<div class="form-group floating-label">
											...
											<label for="regular4">Tipo nomina</label>
										</div>
...
<script src="styles/js/c_TipoNomina/c_TipoNomina_Agregar.js"></script>
<!-- Clases -->
<script>
